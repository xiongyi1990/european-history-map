...
export const historyWindows=[{year:-1500,title:'宫殿中心与线形文字 A'},{year:-1300,title:'迈锡尼与线形文字 B'},{year:-500,title:'波斯与爱琴海东岸'},{year:-431,title:'城邦、盟友与居民身份'},{year:-415,title:'叙拉古与西西里远征'},{year:-330,title:'亚历山大的征服世界'},{year:-218,title:'罗马、迦太基与希腊化王国'},{year:-180,title:'战败后的迦太基与希腊化王国'},{year:-146,title:'迦太基被攻陷之后'},{year:-133,title:'帕加马遗赠罗马'},{year:-64,title:'安条克与罗马的叙利亚行省'},{year:-30,title:'埃及转入罗马统治'},{year:300,title:'四帝共治：特里尔、米兰与东部驻地'},{year:395,title:'罗马帝国的东部朝廷'},{year:400,title:'两部朝廷、北非粮运与巴尔干港口'},{year:439,title:'迦太基转入汪达尔统治'},{year:500,title:'东哥特、西哥特、法兰克与汪达尔'},{year:533,title:'东罗马重新取得迦太基'},{year:540,title:'查士丁尼时代的意大利'},{year:800,title:'亚琛、罗马与科尔多瓦'},{year:843,title:'凡尔登分割后的亚琛'},{year:950,title:'科尔多瓦哈里发国'},{year:1066,title:'诺曼征服与伦敦加冕'},{year:1080,title:'诺曼征服后的伦敦'},{year:1099,title:'十字军与耶路撒冷'},{year:1100,title:'耶路撒冷王国的起点'},{year:1187,title:'萨拉丁取得耶路撒冷'},{year:1204,title:'君士坦丁堡与拉丁帝国'},{year:1350,title:'阿维尼翁与教皇领地'},{year:1492,title:'格拉纳达的政权易手'},{year:1517,title:'维滕贝格与宗教改革'},{year:1618,title:'布拉格与三十年战争'},{year:1642,title:'伦敦与英格兰内战'}];
