...
export function Roman300Atlas({selected,onRegion,onPlace,onBack,onFrontier}:{selected?:string;onRegion:(id:string)=>void;onPlace:(id:string)=>void;onBack:()=>void;onFrontier:(id:string)=>void}){
